 ...
 */
function AdminDetailKegiatan({ onNavigate, selectedProject, onProjectChange, activities, setActivities, petugas, setPetugas, refreshData, loading }) {
  const selectedActivity = activities.find(a => a.name === selectedProject);
  const setSelectedActivity = () => {};
  // if (!selectedActivity) return <div>Pilih Kegiatan</div>;
  ...
  if (loading) {
    return (
      <AdminLayout tab="admin-detail-kegiatan" onNavigate={onNavigate} selectedProject={selectedProject} onProjectChange={onProjectChange} activities={activities}>
...
export default AdminDetailKegiatan;
